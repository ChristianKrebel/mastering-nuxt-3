<template>
  ...
  <NuxtLink v-if="lesson.downloadUrl" :to="lesson.downloadUrl">
    <button class="bg-orange-300 text-orange-900 rounded-xl px-4 py-1 mr-4 hover:bg-orange-200 hover:text-orange-800">Download Video</button>
  </NuxtLink>
  <NuxtLink v-if="lesson.sourceUrl" :to="lesson.sourceUrl">
    <button class="bg-orange-300 text-orange-900 rounded-xl px-4 py-1 hover:bg-orange-200 hover:text-orange-800">Download Source</button>
  </NuxtLink>
  <p>{{ lesson.text }}</p>
</template>
